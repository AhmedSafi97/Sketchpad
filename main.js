const container = document.querySelector('#container');
      container.setAttribute('style', 'width: 480px; height: 480px; border: 1px solid black; display: flex; flex-wrap: wrap');
...
const sidebar = document.querySelector('#sidebar');
      sidebar.setAttribute('style', 'width: 480px; height: 51px; border: 1px solid black; display: flex; flex-flow: row');
...
const grid = document.querySelectorAll('.content');
      ...
      grid.forEach((content) => {
            ...
            content.style.background = "#"+((1<<24)*Math.random()|0).toString(16);});}
       );
       ...
       function myFunction() {
        ...
        if(n <= 0 || n % 1 != 0 || m <= 0 || m % 1 != 0){alert("wrong input");}
        else{        
